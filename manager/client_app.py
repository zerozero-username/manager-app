...
def client_app_db():
        ...
        store_id_label = Label(client_app, text='ID', font=('bold', 12))
        ...
        #! Listboxes
        store_info = Listbox(client_app, height=10, width=72)
        store_info.grid(row=5, column=0, columnspan=4, ipady=4, ipadx=4, padx=6, pady=6)

        store_info_label = Label(client_app, text='Address', font=('bold', 12))
        store_id_label.grid(row=4, column=2, padx=2, pady=2)
